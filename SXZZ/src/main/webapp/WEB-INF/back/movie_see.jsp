...
function firstPage() {
	page = 1;
	window.location.href="/SXZZ/Back/movie_see?page="+page;
}
...
if(mess.length > 3) {
	...
	function doDelete(id,name) {
		...
		if(res) {
			window.location.href="/SXZZ/Back/delMovie?id="+id+"&name="+name;
		}
	}
...
<body>
	...
	<div class="formbody">
		...
		<div class="upload">
			<form onsubmit="return checkMe()" action="/SXZZ/Back/upload_movie"
