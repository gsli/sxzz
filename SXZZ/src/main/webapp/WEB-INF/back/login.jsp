...
<script src="/SXZZ/back/js/cloud.js" type="text/javascript"></script>
...
<body
	style="background-color: #1c77ac; background-image: url(/back/images/light.png); background-repeat: no-repeat; background-position: center top; overflow: hidden;">
		...
		<div class="loginbox">
			...
			<ul>
				...
				<li><input name="" type="button" class="loginbtn" value="登录"
					onclick="javascript:window.location='/SXZZ/Back/main'" /><label><input
